...
def parse_args():
    ...
    parser.add_argument('--load_lxmert', dest='load_lxmert', type=str, default=None,
                        help='Load the pre-trained LXMERT model.')
    parser.add_argument('--load_probe_head', dest='load_probe_head', type=str, default=None,
                        help='Load the probe head.')
    ...
    parser.add_argument("--remark", type=str, default='', help='experiment note')
